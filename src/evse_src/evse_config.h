...
#define UPDATED_OTA_ENABLE (1)

#define EVSE_SESSION_RESUME_ENEABLED (1)
#define EVSE_SESSION_RESUME_DISABLED (1)
#define EVSE_LCD_ENABLE (1)
#define EVSE_DWIN_ENABLE (0)

#define EVSE_RELAY_WELD_DETECTION (0)
...
#if EVSE_7_4_
#define EVSE_CHARGE_POINT_FIRMWARE_OTA_VERSION String("1.0")
#define DEVICE_ID String("evse_001")
#define EVSE_CHARGE_POINT_FIRMWARE_VERSION String("EVSE_7.4KW_V_1.0")
#define EVSE_CHARGE_POINT_VENDOR String("EVRE")
